...
function handlerProductClick(event) {
  ...
  const currentItem = event.target.closest(".js-product-item");
  console.log(currentItem);
  const viewPic = event.target.dataset.source;
  const clickedImage = images.find((img) => img.original === viewPic);
